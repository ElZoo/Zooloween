...
scenePrincipal.onNuevoMob = function(mob) {
  ...
  mob.barra_vida = this.add.container(0, 0, [vida_fondo, vida_color, vida_borde]);
  if(mob.escala > 1) {
    mob.barra_vida.setScale(0.4*mob.escala, 0.4*mob.escala);
  } else {
    mob.barra_vida.setScale(0.4, 0.4);
  }
